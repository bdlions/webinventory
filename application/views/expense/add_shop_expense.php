            ...
            <div class="row-fluid">
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        <?php echo form_open("expense/add_shop_expense", array('id' => 'form_add_shop_expense')); ?>
                            ...
                            <div class="span5">
                                <fieldset>
                                    ...
                                    <div class="clr span10">
                                        ...
                                        <span class="fr">
                                            <?php echo form_dropdown('shop_list', $shop_list); ?>
                                        </span>			
                                    </div>
                                    <div class="clr span10">
                                    ...
                                    <div class="clr span10">
                                        <span class="fl"></span>
                                        <span class="fr">
                                            <?php echo form_submit($submit_add_shop_expense); ?>
                                        </span>			
                                    </div>                                      
                                </fieldset>                                		
                            </div>                     
