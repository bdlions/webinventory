...
<script>
    function append_selected_product(prod_info)
    {
        ...
        current_temp_product_html = current_temp_product_html + '<input id="' + prod_info['id'] + '" name="purchase_order_no" class="form-control" type="text" value="1"/></div><div class ="col-md-2">';
        current_temp_product_html = current_temp_product_html + '<input name="product_code" readonly="true" class="form-control" type="text" value="' + prod_info['code'] + '"/></div><div class ="col-md-2">';
        ...
        current_temp_product_html = current_temp_product_html + '<input readonly="true" id="' + prod_info['id'] + '" class="form-control" type="text" name="unit_price" value="' + prod_info['unit_price'] + '"/></div><div class ="col-md-2">';
        current_temp_product_html = current_temp_product_html + '<input id="' + prod_info['id'] + '" name="discount" class="form-control" type="text" value="0"/></div><div class ="col-md-2">';
        current_temp_product_html = current_temp_product_html + '<input name="product_sale_price" readonly="true" class="form-control" type="text" value="' + prod_info['unit_price'] + '"/></div>';
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var counter = 0; counter < prod_list.length; counter++)
                    {
                        ...
                        current_temp_html_product = current_temp_html_product + '<input id="' + prod_info['id'] + '" class="form-control" type="text" value="' + prod_info['name'] + '"/>';
...
//            console.log(this);
//            console.log($(["name=product_sale_price"]).text());
        ...
        $("#save_sale_order").on("click", function() {
            ...
            $("#div_selected_product_list").each(function() {
                ...
                $("input", $(this)).each(function() {
                    ...
                    if ($(this).attr("name") === "product_sale_price")
                    {
                        console.log("set subtotal callded....");
        ...
        <div class="row margin-top-bottom">
            <div class ="col-md-12 form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class ="col-md-3 col-md-offset-5">
                        <?php echo form_button(array('name' => 'save_sale_order', 'id' => 'save_sale_order', 'content' => 'Save')); ?>
                    </div> 
                </div>
            </div>
        </div>
