...
<h3>Return Warehouse Purchase Order</h3>
            ...
            <div class="row">
                <div class ="col-md-7 form-horizontal margin-top-bottom">
                    ...
                    <div class="form-group">
                        ...
                        <div class ="col-md-8">
                            <?php echo form_input(array('type'=>'hidden', 'name' => 'input_raise_purchase_product', 'id' => 'input_raise_purchase_product', 'class' => 'form-control', 'data-toggle' => 'modal', 'data-target' => '#common_modal_select_return_product')); ?>
                        </div> 
                    </div>
                </div>
