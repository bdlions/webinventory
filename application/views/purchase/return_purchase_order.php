...
<h3><?php echo $this->lang->line("return_purchase_order_header"); ?></h3>
                ...
                <div class ="col-md-7 form-horizontal margin-top-bottom">
                    <div class="form-group">
                        <label for="input_raise_purchase_supplier" class="col-md-3 control-label requiredField">
                             <?php echo $this->lang->line("return_purchase_order_supplier_name"); ?>
                        </label>
                        <div class ="col-md-8">
                    ...
                    <div class="form-group">
                        <label for="input_raise_purchase_phone" class="col-md-3 control-label requiredField">
                             <?php echo $this->lang->line("return_purchase_order_phone_no"); ?>
                        </label>
                        <div class ="col-md-8">
                    ...
                    <div class="form-group">
                        <label for="input_raise_purchase_company" class="col-md-3 control-label requiredField">
                             <?php echo $this->lang->line("return_purchase_order_company"); ?>
                        </label>
                        <div class ="col-md-8">
                    ...
                    <div class="form-group">
                        <label for="input_raise_purchase_product" class="col-md-3 control-label requiredField">
                             <?php echo $this->lang->line("return_purchase_order_product"); ?>
                        </label>
                        <div class ="col-md-8">
                ...
                <div class ="col-md-5 form-horizontal margin-top-bottom">
                    <div class="form-group">
                        <label for="input_raise_purchase_order_no" class="col-md-4 control-label requiredField">
                            <?php echo $this->lang->line("return_purchase_order_lot_no"); ?>
                        </label>
                        <div class ="col-md-8">
            ...
            <div class="row col-md-11">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th><?php echo $this->lang->line("return_purchase_order_product_name"); ?></th>
                                <th><?php echo $this->lang->line("return_purchase_order_quantity"); ?></th>
                                <th><?php echo $this->lang->line("return_purchase_order_product_unit"); ?></th>
                                <th><?php echo $this->lang->line("return_purchase_order_unit_price"); ?></th>
                                <th><?php echo $this->lang->line("return_purchase_order_sub_total"); ?></th>
                            </tr>
                        </thead>
                ...
                <div class ="col-md-12 form-horizontal">
                    <div class="form-group">
                        <label for="remarks" class="col-md-2 control-label requiredField">
                            <?php echo $this->lang->line("return_purchase_order_return_remarks"); ?>
                        </label>
                    ...
                    <div class="form-group">
                        <label for="total_purchase_price" class="col-md-2 control-label requiredField">
                            <?php echo $this->lang->line("return_purchase_order_return_total"); ?>
                        </label>
                        <div class ="col-md-3 col-md-offset-5">
                    ...
                    <div class="form-group">
                        <label for="previous_due" class="col-md-2 control-label requiredField">
                            <?php echo $this->lang->line("return_purchase_order_return_previous_due"); ?>
                        </label>
                        <div class ="col-md-3 col-md-offset-5">
                    ...
                    <div class="form-group">
                        <label for="current_due" class="col-md-2 control-label requiredField">
                            <?php echo $this->lang->line("return_purchase_order_return_current_due"); ?>
                        </label>
                        <div class ="col-md-3 col-md-offset-5">
                    ...
                    <div class="form-group">
                        <label for="return_balance" class="col-md-2 control-label requiredField">
                            <?php echo $this->lang->line("return_purchase_order_return_return_balance"); ?>
                        </label>
                        <div class ="col-md-3 col-md-offset-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class ="col-md-3 col-md-offset-5">
                            <?php echo form_button(array('name' => 'button_raise_purchase_order', 'id' => 'button_raise_purchase_order', 'content' => $this->lang->line("return_purchase_order_return_update"), 'class' => 'form-control btn-success')); ?>
                        </div> 
                    </div>
                </div>
            </div>
