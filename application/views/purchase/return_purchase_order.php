<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#return_showroom_purchase_order_product_category1").change(function() {
            return_purchase_info();
        });
        $("#return_showroom_purchase_order_product_size").change(function() {
            return_purchase_info();
        });
        ...
        $("#modal_button_confirm").on("click", function() {
            if (get_modal_confirmation_category_id() === get_modal_confirmation_return_purchase_order_category_id())
            {
                ...
                $("tr", "#tbody_selected_product_list").each(function() {
                    ...
                    $("input", $(this)).each(function() {
                        ...
                        if ($(this).attr("name") === "quantity")
                        {
                            ...
                            product_info.setProductCategory1($("#return_showroom_purchase_order_product_category1").val());
                            product_info.setProductSize($("#return_showroom_purchase_order_product_size").val());
                        }
                ...
                purchase_info.setProductCategory1($("#return_showroom_purchase_order_product_category1").val());
                purchase_info.setProductSize($("#return_showroom_purchase_order_product_size").val());
    ...
    function return_purchase_info() {
        $.ajax({
            ...
            data: {
                ...
                product_category1: $("#return_showroom_purchase_order_product_category1").val(),
                product_size: $("#return_showroom_purchase_order_product_size").val()
            },
            success: function(data) {
        ...
        <div class ="col-md-8 form-horizontal">
            <div class="row">
                ...
                <div class ="col-md-5 form-horizontal margin-top-bottom">
                    ...
                    <div class="form-group">
                        <label for="return_showroom_purchase_order_product_category1" class="col-md-4 control-label requiredField">
                            Sub Lot No
                        </label>
                        <div class ="col-md-8">
                            <select name="return_showroom_purchase_order_product_category1" id="return_showroom_purchase_order_product_category1" class="form-control">
                    ...
                    <div class="form-group">
                        <label for="return_showroom_purchase_order_product_size" class="col-md-4 control-label requiredField">
                            Size
                        </label>
                        <div class ="col-md-8">
                            <select name="return_showroom_purchase_order_product_size" id="return_showroom_purchase_order_product_size" class="form-control">
