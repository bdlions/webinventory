        ...
        $("#modal_button_confirm").on("click", function() {
            if( get_modal_confirmation_category_id() === get_modal_confirmation_raise_purchase_order_category_id() )
            {
                ...
                $.ajax({
                    dataType: 'json',
                    type: "POST",
                    url: '<?php echo base_url(); ?>' + "purchase/raise_warehouse_purchase",
                    data: {
            ...
            <div class="row">
                <div class ="col-md-7 form-horizontal margin-top-bottom">
                    ...
                    <div class="form-group">
                        ...
                        <div class ="col-md-8">
                            <?php echo form_input(array('type'=>'hidden', 'name' => 'input_raise_purchase_product', 'id' => 'input_raise_purchase_product', 'class' => 'form-control', 'data-toggle' => 'modal', 'data-target' => '#common_modal_select_product')); ?>
                        </div> 
                    </div>
                </div>
