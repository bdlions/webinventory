<script type="text/javascript">
    ...
    function open_modal_status_confirm(card_no) {
        $('#input_client_id').val(card_no);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Inactive Customer</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="row form-group">
                        <div class ="col-sm-2"></div>
                        <label class="col-sm-10 control-label">Are you sure to inactive this Customer?</label>
