...
<h3><?php echo $this->lang->line("search_search_sales_customer_phone_search_customer_sale_by_phone"); ?></h3>
                ...
                <tr>
                    <td>
                        <label for="phone" class="col-md-6 control-label requiredField">
                            <?php echo $this->lang->line("search_search_sales_customer_phone_phone"); ?>
                        </label>
                        <div class ="col-md-6">
                    ...
                    <td>
                        <label class="col-md-6 control-label requiredField">
                            <?php echo $this->lang->line("search_search_sales_customer_phone_total_sale_price"); ?> : 
                        </label>
                    ...
                    <td>                        
                        <label class="col-md-6 control-label requiredField">
                            <?php echo $this->lang->line("search_search_sales_customer_phone_total_quantity"); ?> : 
                        </label>
                    ...
                    <td>
                        <label class="col-md-6 control-label requiredField">
                            <?php 
                                if($this->session->userdata('user_type') != SALESMAN)
                                {                                    
                                    echo $this->lang->line("search_search_sales_customer_phone_total_profit").' : ';
                                }
                            ?>
...
<h3><?php echo $this->lang->line("search_search_sales_customer_phone_search_result"); ?></h3>
<div class="form-background top-bottom-padding">
    <div class="table-responsive">
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_customer_name"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_phone"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_card_no"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_product_name"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_lot_no"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_quantity"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_product_unit"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_purchase_unit_price"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_sale_unit_price"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_total_purchase_price"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_total_sale_price"); ?></th>
                    <th><?php echo $this->lang->line("search_search_sales_customer_phone_transactions"); ?></th>
                    <?php 
                        if($this->session->userdata('user_type') != SALESMAN)
                        {                                    
                            echo '<th>'.$this->lang->line("search_search_sales_customer_phone_net_profit").'</th>';
                        }                            
                    ?> 
                    <?php 
                        if($this->session->userdata('user_type') != SALESMAN)
                        {                                    
                            echo '<th>'.$this->lang->line("search_search_sales_customer_phone_return").'</th>';
                        }                            
                    ?>
                    <?php 
                        if($this->session->userdata('user_type') != SALESMAN)
                        {                                    
                            echo '<th>'.$this->lang->line("search_search_sales_customer_phone_delete").'</th>';
                        }                            
                    ?>
                </tr>
            </thead>
