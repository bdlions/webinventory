...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#form_edit_message").on("submit", function(){
            $("#editortext").val(jQuery('<div />').text(CKEDITOR.instances.editor1.getData()).html());
            //return false;
        });
    });
</script>
<h3>Edit Supplier Message</h3>
<div class ="row form-horizontal form-background top-bottom-padding">
    <?php echo form_open("sms/update_supplier_message/".$supplier_message_info['id'], array('id' => 'form_edit_message', 'class' => 'form-horizontal')); ?>
