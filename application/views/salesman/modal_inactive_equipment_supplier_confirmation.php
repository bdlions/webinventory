<script type="text/javascript">
    ...
    function open_modal_status_confirm(user_id) {
        $('#input_client_id').val(user_id);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Inactive Equipment Supplier</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="row form-group">
                        <div class ="col-sm-2"></div>
                        <label class="col-sm-10 control-label">Are you sure to inactive this Equipment Supplier?</label>
