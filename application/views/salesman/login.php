...
<div class="container">
    <div class="row">
        ...
        <div class ="col-md-4 col-md-offset-4 boxshad" style="background-image:url(<?php echo base_url(); ?>/assets/images/loginBGsales.jpg);background-repeat:no-repeat;background-size: 100% 100%;">
            <div class =" row">
                <div class ="col-md-12">
