...
class Purchase_model extends Ion_auth_model 
{
     ...
     */
    public function add_warehouse_purchase_order($additional_data, $warehouse_purchased_product_list, $add_warehouse_stock_list, $supplier_payment_data, $supplier_transaction_info_array)
    {
     ...
     * @Author Nazmul on 14th January 2015
     */
    public function raise_warehouse_purchase_order($additional_data, $new_warehouse_purchased_product_list, $add_warehouse_stock_list, $supplier_transaction_info_array)
     {
        ...
        if( !empty($new_warehouse_purchased_product_list) )
        {
            $this->db->insert_batch($this->tables['warehouse_product_purchase_order'], $new_warehouse_purchased_product_list);         
        }
        if( !empty($add_warehouse_stock_list) )
        {
            $this->db->insert_batch($this->tables['warehouse_stock_info'], $add_warehouse_stock_list);            
...
//        }
     ...
     * @Author Nazmul on 14th January 2015
     */
    public function get_purchased_product_list($purchase_order_no)
    {
//        if($shop_id == 0)
//        {
//            $shop_id = $this->session->userdata('shop_id');
