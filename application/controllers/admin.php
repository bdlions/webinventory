...
class Admin extends CI_Controller {
    ...
    function admin_login() {
        ...
        $this->login_success_uri = ADMIN_LOGIN_SUCCESS_URI;
        $this->login_uri = ADMIN_LOGIN_URI;
        $this->login_template = ADMIN_LOGIN_TEMPLATE;
        $this->login_view = ADMIN_LOGIN_VIEW;
        ...
        if (!$this->ion_auth->logged_in()) {
            ...
            $this->template->load(ADMIN_LOGIN_SUCCESS_TEMPLATE, ADMIN_LOGIN_SUCCESS_VIEW, $this->data);
        }
    }
